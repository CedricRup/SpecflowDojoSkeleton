...
Scénario: Quand un développeur travaille sur une story, la charge de travail restante sur la story diminue
	...
	Et le daily pour le projet 'Crocto'
...
@US001
Scénario: Quand un développeur ne travaille pas sur une story, la charge de travail restante sur la story ne diminue pas

	Etant donné le projet 'Crocto' avec les stories suivantes
	| Titre                | Charge |
	| Souscrire un contrat | 2      |
	| Resilier un contrat  | 4      |
